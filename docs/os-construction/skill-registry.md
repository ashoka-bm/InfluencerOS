...
| `create-lead-magnet` | create lead magnet, build the conversion asset, make the opt-in PDF, strategy references a lead magnet or offer | `content-strategy.json`, `creator-profile.json`, `brand_context/personal-brand.md`, `references/brand/<slug>-brand-system.md`, approved `references/character/<slug>-identity-plate.png`, bundled template assets | `conversion-assets/<slug>-lead-magnet.{json,md,pdf}`, `references/brand/<slug>-theme.css`; generated reference imagery only via the approval gate (`request-generation-approval` → `record-generation-approval` → `import-generated-asset` → BLOCKING `review-generated-assets`, Reference-Library route) | yes |
